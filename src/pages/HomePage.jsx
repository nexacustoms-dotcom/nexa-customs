...
export default function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="W">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 410px', gap: 60, alignItems: 'center', position: 'relative', zIndex: 1 }} className="hero-grid">
            ...
            <div className="hero-right">
              <div style={{ background: 'var(--sf)', border: '1px solid var(--bd)', borderRadius: 18, overflow: 'hidden', boxShadow: '0 36px 88px rgba(0,0,0,.55)', padding: 36, minHeight: 260, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative' }}>
                <div style={{ fontSize: 64, marginBottom: 16 }}>{slides[slide].ico}</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 32, justifyContent: 'space-between' }} className="testi-row">
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
                ...
                <div><div style={{ fontWeight: 700, fontSize: 13 }}>{TESTIMONIALS[tIdx].a}</div><div style={{ fontSize: 11, color: 'var(--mu)' }}>{TESTIMONIALS[tIdx].co}</div></div>
              </div>
            </div>
      ...
      <style>{`
        .hero-grid { @media(max-width:1060px) { grid-template-columns:1fr !important; } }
        .hero-right { @media(max-width:1060px) { display:none !important; } }
        .cat-grid { @media(max-width:1060px) { grid-template-columns:repeat(4,1fr) !important; } @media(max-width:640px) { grid-template-columns:repeat(3,1fr) !important; } }
        .prod-grid-4,.feat-grid { @media(max-width:1060px) { grid-template-columns:repeat(2,1fr) !important; } @media(max-width:480px) { grid-template-columns:1fr !important; } }
        .testi-row { @media(max-width:640px) { flex-direction:column !important; } }
      `}</style>
    </div>
  );
}
